  ...
  try {
    ...
    const [s1, s2, s3, s4, s5, s6, s7] = await Promise.all([
      ...
      callClaude(AGENT_AUDITOR,
        brief + `\n\nAs the Paid Media Auditor, conduct a focused account audit. STRICT LIMIT: maximum 500 words total. Focus on top 3-4 priorities only. Maximum 3-4 key points per section. Do not provide technical implementation instructions, code, tag setup steps, or platform configuration details. Focus exclusively on business strategy, budget recommendations, and performance outcomes.\n\n1. Account Structure Assessment\n2. Bidding & Budget Evaluation\n3. Competitive Positioning\n4. Priority Fix List (Critical / High only) with estimated efficiency improvement\n\nUse clear sections. Use real line breaks between items.`
      ),

      callClaude(AGENT_TRACKING,
        brief + `\n\nAs the Tracking & Measurement Specialist, provide a business-focused measurement strategy. STRICT LIMIT: maximum 500 words total. Focus on top 3-4 priorities only. Maximum 3-4 key points per section. Do not provide technical implementation instructions, code, tag setup steps, or platform configuration details. Focus exclusively on business strategy, budget recommendations, and performance outcomes.\n\n1. Measurement Gaps & Business Impact\n2. Attribution Strategy & Budget Implications\n3. Key Conversion Events to Prioritise\n4. ROI Tracking Recommendations\n\nUse real line breaks between items.`
      ),

      callClaude(AGENT_SEARCH_QUERY,
        brief + `\n\nAs the Search Query Analyst, deliver a focused search strategy. STRICT LIMIT: maximum 500 words total. Focus on top 3-4 priorities only. Maximum 3-4 key points per section. Do not provide technical implementation instructions, code, tag setup steps, or platform configuration details. Focus exclusively on business strategy, budget recommendations, and performance outcomes.\n\n1. Wasted Spend Patterns & Estimated % of Budget at Risk\n2. Top Keyword Opportunities to Prioritise\n3. Intent Strategy & Audience Alignment\n4. Budget Reallocation Recommendations\n\nUse real line breaks between items.`
      ),

      callClaude(AGENT_PPC,
        brief + `\n\nAs the PPC Campaign Strategist, build a focused PPC strategy. STRICT LIMIT: maximum 500 words total. Focus on top 3-4 priorities only. Maximum 3-4 key points per section. Do not provide technical implementation instructions, code, tag setup steps, or platform configuration details. Focus exclusively on business strategy, budget recommendations, and performance outcomes.\n\n1. Campaign Structure & Budget Allocation\n2. Bidding Strategy with Business Rationale\n3. Audience & Targeting Priorities\n4. 90-Day Growth Roadmap with RICE scoring\n\nUse real line breaks between items.`
      ),

      callClaude(AGENT_CREATIVE,
        brief + `\n\nAs the Ad Creative Strategist, deliver a focused creative strategy. STRICT LIMIT: maximum 500 words total. Focus on top 3-4 priorities only. Maximum 3-4 key points per section. Do not provide technical implementation instructions, code, tag setup steps, or platform configuration details. Focus exclusively on business strategy, budget recommendations, and performance outcomes.\n\n1. Core Messaging Strategy & Value Proposition\n2. Top Creative Angles & Ad Formats to Prioritise\n3. Creative Testing & Budget Allocation Plan\n4. Competitive Differentiation & Expected Performance Uplift\n\nUse real line breaks between items.`
      ),

      callClaude(AGENT_PAID_SOCIAL,
        brief + `\n\nAs the Paid Social Strategist, deliver a focused paid social strategy. STRICT LIMIT: maximum 500 words total. Focus on top 3-4 priorities only. Maximum 3-4 key points per section. Do not provide technical implementation instructions, code, tag setup steps, or platform configuration details. Focus exclusively on business strategy, budget recommendations, and performance outcomes.\n\n1. Platform Priorities & Budget Split Rationale\n2. Full-Funnel Audience Strategy\n3. Creative & Messaging Approach per Platform\n4. ROAS / CPL Targets & Performance Benchmarks\n\nUse real line breaks between items.`
      ),

      callClaude(AGENT_PROGRAMMATIC,
        brief + `\n\nAs the Programmatic & Display Buyer, deliver a focused display strategy. STRICT LIMIT: maximum 500 words total. Focus on top 3-4 priorities only. Maximum 3-4 key points per section. Do not provide technical implementation instructions, code, tag setup steps, or platform configuration details. Focus exclusively on business strategy, budget recommendations, and performance outcomes.\n\n1. Channel Mix & Budget Allocation Rationale\n2. Audience Strategy & Targeting Priorities\n3. Partner Media & Placement Priorities\n4. Upper-Funnel ROI Expectations & CPM Benchmarks\n\nUse real line breaks between items.`
      )
